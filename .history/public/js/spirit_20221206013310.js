...
class Stage extends Item {
    static boundary = {
        cx: 0, fx: window.innerWidth, cy: 0, fy: window.innerHeight,
        check: function (pos) {
...
class Fish extends Item {
    static generator = {
        ...
        create: function (render, boundary) {
            ...
            const rand = Fish.generator.rand, level = 6
    ...
    static config = {
        ...
        5: {
            size: { w: 67, h: 122 }, collision: { x: 4, y: - 7, w: 41, h: 72 },
            captureRate: .35, price: 20
        },
        6: {
            size: { w: 100, h: 70 }, collision: { x: 5, y: - 7, w: 81, h: 102 },
            captureRate: .35, price: 20
        },
        7: {
            size: { w: 107, h: 222 }, collision: { x: 4, y: - 7, w: 91, h: 72 },
            captureRate: 0, price: 20
        },
        8: {
