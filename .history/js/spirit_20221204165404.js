...
class Gun extends Item {
    init() {
        ...
        this.xOffset = 0, this.yOffset = 10, this.angle = 0
        this.bullet = null
    ...
    draw(ctx) {
        ...
        const ratio = 2
        // const width = 161 * ratio, height = 187 * ratio
        ctx.save()
        ...
        ctx.drawImage(img, 0, 0 + height * this.frame.index, width + 200, height + 200, 0, 0, width, height)
        ctx.restore()
    }
